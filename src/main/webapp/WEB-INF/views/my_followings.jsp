					...
					<c:when test="${sessionScope.user != null}">
				        <table class="table table-bordered table-hover table-striped display">
				            ...
				            <c:forEach items="${followings}" var="following">
				            	<tr>
				            		<td>${following.fid}</td>
				            		<td>${following.event.eventName}</td>
				            		<td>${following.event.startDate}</td>
				            		<td>${following.event.endDate}</td>
				            		<td>${following.event.location}</td>
				            		<td><a href="./event/home?eventId=${following.event.eid}"><button type="button">&nbspView&nbsp</button></a>&nbsp&nbsp<a href="./following/cancel?followingId=${following.fid}"><button type="button">Unfollow</button></a></td>
				            	</tr>
				            </c:forEach>
				            <tr height="50px">
				            </tr>
