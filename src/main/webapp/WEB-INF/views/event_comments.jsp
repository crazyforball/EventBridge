		...
		<div class="container">
			<div align="center">
				<table align="center">
					<tr>
						<td></td>
						<td align="center"><h1>${event.eventName}</h1></td>
						<td></td>
					</tr>
					<tr height="10px">
					</tr>
					<tr class="event-info">
						<%-- <c:choose> --%>
							<%-- <c:when test="${positiveRate != null}"> --%>
								<td class="rating"><a href="./event/comments?eventId=${event.eid}&option=1">${positiveRate}% Positive Feedback</a></td>
							<%-- </c:when> --%>
							<%-- <c:when test="${neutralRate != null}"> --%>
								<td class="rating"><a href="./event/comments?eventId=${event.eid}&option=0">${neutralRate}% Neutral Feedback</a></td>
							<%-- </c:when> --%>
							<%-- <c:when test="${positiveRate != null}"> --%>
								<td class="rating"><a href="./event/comments?eventId=${event.eid}&option=-1">${negativeRate}% Negative Feedback</a></td>
							<%-- </c:when> --%>
						<%-- </c:choose> --%>
					</tr>
				</table>
